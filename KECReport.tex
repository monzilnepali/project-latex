...
\subsection{Why Incremental Development Model?}
...
Fig 4.2 first part is entry point of our application.Fig 4.2 second part is where user inputs their name,age and gender.
...
User provide symptoms by selecting from the drop down menu as shown in Fig 4.3 first part.Symptoms list is fetch from restful API and after clicking the examine button user symptom is send to the server and got response back from server in Fig 4.3 second part showing the top 4 probable diseases.Disease information like symptoms,causes and treament are display here.
...
\end{center}
\end{figure}
Fig 4.4 first part shows  Medicine Reminder Entry point where add medicine details like Medicine name,medicine dosage,medicine time 
...
Medicine reminder alert screen is shown in Fig 4.5 first part where it shows detail about the medicine name,medicine dosage, and medicine time.Fig 4.5 second part shows the emergency contacts
